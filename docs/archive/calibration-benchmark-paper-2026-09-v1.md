...
Every number here is computed from the per-trial file beside `swarm_benchmark.json`; the reasoning and the caveats are in `docs/methods.md`, "Uncertainty and probability", and on the findings page.
